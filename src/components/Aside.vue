<template>
  <div class="aside">
    <span :class="[view === 'Film' ? 'active ': ''] + 'zy-svg'" role="button" tabindex="0" aria-label="电影" :aria-current="view === 'Film' ? 'page' : null" @click="changeView('Film')" @keydown.enter.prevent="changeView('Film')" @keydown.space.prevent="changeView('Film')">
    ...
    <span :class="[view === 'Douban' ? 'active ': ''] + 'zy-svg'" role="button" tabindex="0" aria-label="豆瓣" :aria-current="view === 'Douban' ? 'page' : null" @click="changeView('Douban')" @keydown.enter.prevent="changeView('Douban')" @keydown.space.prevent="changeView('Douban')">
    ...
    <span :class="[view === 'Play' ? 'active ': ''] + 'zy-svg'" role="button" tabindex="0" aria-label="播放" :aria-current="view === 'Play' ? 'page' : null" @click="changeView('Play')" @keydown.enter.prevent="changeView('Play')" @keydown.space.prevent="changeView('Play')">
    ...
    <span :class="[view === 'Star' ? 'active ': ''] + 'zy-svg'" role="button" tabindex="0" aria-label="收藏" :aria-current="view === 'Star' ? 'page' : null" @click="changeView('Star')" @keydown.enter.prevent="changeView('Star')" @keydown.space.prevent="changeView('Star')">
    ...
    <span :class="[view === 'History' ? 'active ': ''] + 'zy-svg'" role="button" tabindex="0" aria-label="历史记录" :aria-current="view === 'History' ? 'page' : null" @click="changeView('History')" @keydown.enter.prevent="changeView('History')" @keydown.space.prevent="changeView('History')">
    ...
    <span :class="[view === 'EditSites' ? 'active ': ''] + 'zy-svg'" role="button" tabindex="0" aria-label="源管理" :aria-current="view === 'EditSites' ? 'page' : null" @click="changeView('EditSites')" @keydown.enter.prevent="changeView('EditSites')" @keydown.space.prevent="changeView('EditSites')">
    ...
    <span :class="[view === 'Setting' ? 'active ': ''] + 'zy-svg'" role="button" tabindex="0" aria-label="设置" :aria-current="view === 'Setting' ? 'page' : null" @click="changeView('Setting')" @keydown.enter.prevent="changeView('Setting')" @keydown.space.prevent="changeView('Setting')">
  ...
  methods: {
    ...
    changeView (e) {
      ...
      if (this.detail.show === true) {
        ...
        this.savedDetail = JSON.parse(JSON.stringify(this.detail))
      }
      this.view = e
